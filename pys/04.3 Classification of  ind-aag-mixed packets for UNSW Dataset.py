...
"DT" :DecisionTreeClassifier(criterion='entropy', max_depth=28.0,
                       max_features=16,min_samples_split= 7),  
...
ml_list={"DT" :DecisionTreeClassifier(criterion='entropy', max_depth=28.0,
                       max_features=16,min_samples_split= 7)}
